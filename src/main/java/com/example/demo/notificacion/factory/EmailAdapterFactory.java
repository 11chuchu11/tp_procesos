package com.example.demo.notificacion.factory;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;
import com.example.demo.notificacion.adapter.AdapterHotmail;
import com.example.demo.notificacion.adapter.AdapterJakartaMail;
